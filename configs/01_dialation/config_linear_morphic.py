...
class Config:
    ...
    mlflow_run_name = "Morphic_Linear_Model" 
    ...
    """ Model parameters """
    from utils.model_linear_interpolation import LinearInterpolationBaseline
    model = LinearInterpolationBaseline
    model_params = {}
    model_save_name = "lesion_morphic_linear_interpolation_model"
