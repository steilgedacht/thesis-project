...
class Config:
    ...
    mlflow_run_name = "Patient_Specific_Dialation_Model" 
    ...
    """ Model parameters """
    from utils.model_dialation_patient_specific import Patient_Specific_Dilation_Model
    model = Patient_Specific_Dilation_Model
    model_params = {}
